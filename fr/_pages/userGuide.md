...
{% include figure image_path="/assets/images/userGuideImagesFR/addHotspotButtonDropdown.png" alt="Les formes d'un hotspot" caption="Trois formes : Courbe, Rectangle et Cercle." %}
